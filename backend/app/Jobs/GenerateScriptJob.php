    ...
    public function handle(): void
    {
        try {
            $payload = [
                ...
                'voice_stability' => $this->video->campaign->user->voice_stability ?? 0.45,
                'voice_similarity_boost' => $this->video->campaign->user->voice_similarity_boost ?? 0.85,
                'voice_style' => $this->video->campaign->user->voice_style ?? 0.05,
